...
async function removeTask(taskId) {
    await (0, _firestore.updateDoc)((0, _firestore.doc)((0, _firebaseJs.db), "scheduler", taskId), {
        completed: true
    });
}
...
async function addTaskToFirestore(taskText) {
    let task = await (0, _firestore.addDoc)((0, _firestore.collection)((0, _firebaseJs.db), "scheduler"), {
        text: taskText,
        email: email,
        completed: false
    });
...
async function getTasksFromFirestore() {
    let q = (0, _firestore.query)((0, _firestore.collection)((0, _firebaseJs.db), "scheduler"), (0, _firestore.where)("email", "==", email));
